  ...
  public function __construct($db)
  {
    ...
    $this->cronjobs = array(
      0 => array(
        ...
        'method'        => 'backup',
        'parameters'    => '',
        'comment'       => 'Dump the database and archive documents, upload as YYYYMMDD_HH_MM_SS/db.bz2 + docs.tar.gz',
        'frequency'     => 1,
        'unitfrequency' => 86400,
        'status'        => 0,
      ...
      1 => array(
        'label'         => 'S3 backup prune',
        'jobtype'       => 'method',
        'class'         => '/s3backup/class/s3backup.class.php',
        'objectname'    => 'S3Backup',
        'method'        => 'pruneBackups',
        'parameters'    => '',
        'comment'       => 'Delete old backup folders from S3 according to the retention policy',
        'frequency'     => 1,
